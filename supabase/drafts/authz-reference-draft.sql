...
CREATE TABLE IF NOT EXISTS office_departments (
    ...
    CONSTRAINT fk_off_dep_office FOREIGN KEY (id_off) REFERENCES offices(id_off),
    CONSTRAINT fk_off_dep_department FOREIGN KEY (id_dep) REFERENCES departments(id_dep),

    UNIQUE (uuid),
    UNIQUE (id_off, id_dep)
...
CREATE TABLE IF NOT EXISTS user_offices (
    ...
    CONSTRAINT fk_user_off_user FOREIGN KEY (id_user) REFERENCES users(id_user),
    CONSTRAINT fk_user_off_office FOREIGN KEY (id_off) REFERENCES offices(id_off),

    UNIQUE (uuid),
    UNIQUE (id_user, id_off)
...
CREATE TABLE IF NOT EXISTS user_departments (
    ...
    CONSTRAINT fk_user_dep_user FOREIGN KEY (id_user) REFERENCES users(id_user),
    CONSTRAINT fk_user_dep_off_dep FOREIGN KEY (id_off_dep) REFERENCES office_departments(id_off_dep),

    UNIQUE (uuid),
    UNIQUE (id_user, id_off_dep)
...
CREATE TABLE IF NOT EXISTS user_ranks (
    ...
    CONSTRAINT fk_user_rank_user FOREIGN KEY (id_user) REFERENCES users(id_user),
    CONSTRAINT fk_user_rank_rank FOREIGN KEY (id_rank) REFERENCES ranks(id_rank),

    UNIQUE (uuid),
    UNIQUE (id_user, id_rank)
...
CREATE TABLE IF NOT EXISTS user_access_roles (
    ...
    CONSTRAINT fk_user_role_role FOREIGN KEY (id_role) REFERENCES access_roles(id_role),
