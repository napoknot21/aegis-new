-- ============================================================
-- AEGIS - shared reference tables draft
-- Scope:
--   - currencies
--   - asset_classes
--
-- Notes:
--   - These tables are global shared references by design.
--   - They are intentionally not tenant-scoped.
--   - If one day a tenant needs local aliases or overrides, add
--     mapping tables on top instead of duplicating these references.
-- ============================================================
